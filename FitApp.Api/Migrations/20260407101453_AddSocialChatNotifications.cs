...
{
    /// <inheritdoc />
    public partial class AddSocialChatNotifications : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedWorkoutId = table.Column<int>(type: "INTEGER", nullable: true),
                    LinkedMealId = table.Column<int>(type: "INTEGER", nullable: true),
                    LinkedDailyEntryId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_DailyEntries_LinkedDailyEntryId",
                        column: x => x.LinkedDailyEntryId,
                        principalTable: "DailyEntries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Posts_MealEntries_LinkedMealId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Posts_WorkoutTemplates_LinkedWorkoutId",
                        column: x => x.LinkedWorkoutId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_LinkedDailyEntryId",
                table: "Posts",
                column: "LinkedDailyEntryId");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_LinkedMealId",
                table: "Posts",
                column: "LinkedMealId");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_LinkedWorkoutId",
                table: "Posts",
                column: "LinkedWorkoutId");
